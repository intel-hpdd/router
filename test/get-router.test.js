...
describe("Router", () => {
  ...
  describe("the all method", () => {
    ...
    it("should not call the get method with post", () => {
      expect(getAction).not.toHaveBeenCalledTimes(1);
    });
  ...
  describe("routing in order", () => {
    ...
    it("should not call the other match", () => {
      expect(wildcardAction).not.toHaveBeenCalledTimes(1);
    });
  });
  ...
  describe("adding routes", () => {
    ...
    beforeEach(() => {
      fooAction1 = jasmine.createSpy("fooAction1").and.callFake((req, resp, next) => {
        next(req, resp);
      });
    ...
    it("should call the new route", () => {
      expect(fooAction2).toHaveBeenCalledTimes(1);
    });
  });
  ...
  describe("route middleware", () => {
    ...
    it("should call middle after before", () => {
      ...
      expect(middleAction).toHaveBeenCalledTimes(1);
    });
